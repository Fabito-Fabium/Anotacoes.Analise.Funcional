...
\qslista{10}{Mostre que a desigualdade de Hölder é satisfeita para $p=1$ e $q=\infty$, i.e.,
se $x=(x_j)\in\ell^1$ e $y=(y_j)\in\ell^\infty$, então
$$\sum_{j=1}^{\infty}|x_jy_j|\leq \|x\|_1\|y\|_\infty\text{.}$$}
