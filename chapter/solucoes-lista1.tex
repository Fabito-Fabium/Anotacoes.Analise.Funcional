...
\end{tcolorbox}
\vspace{4mm}
\begin{exercicio}{Seja $(X,d)$ um espaço métrico. Mostre que $\abs{d(x,z)-d(z,y)}\le d(x,y)$ e $\abs{d(x_1,y_1)-d(x_2,y_2)}\le d(x_1,x_2)+d(y_1,y_2)$.}
\sol
\textbf{(i)} Pela desigualdade triangular e pela simetria,
\[ d(x,z) \le d(x,y)+d(y,z) \quad\Longrightarrow\quad d(x,z)-d(z,y) \le d(x,y). \]
Trocando os papéis de $x$ e $y$: $d(z,y)\le d(z,x)+d(x,y)$, logo $d(z,y)-d(x,z)\le d(x,y)$. Como o módulo de um número real é o maior entre ele e seu simétrico, concluímos $\abs{d(x,z)-d(z,y)}\le d(x,y)$.

\textbf{(ii)} Usando a desigualdade triangular duas vezes,
\[ d(x_1,y_1) \le d(x_1,x_2)+d(x_2,y_2)+d(y_2,y_1), \]
donde $d(x_1,y_1)-d(x_2,y_2)\le d(x_1,x_2)+d(y_1,y_2)$. Permutando os índices $1$ e $2$ obtemos a desigualdade simétrica $d(x_2,y_2)-d(x_1,y_1)\le d(x_1,x_2)+d(y_1,y_2)$. As duas juntas dão o resultado.
\end{exercicio}
